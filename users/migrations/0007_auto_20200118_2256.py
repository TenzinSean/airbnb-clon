# Generated by Django 2.2.5 on 2020-01-18 22:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='user',
            name='langauge',
            field=models.CharField(blank=True, choices=[('en', 'English'), ('tb', 'Tibetan')], default='tb', max_length=2, verbose_name='language'),
        ),
    ]
